...
class TreasureHunters:
    def __init__(self):
        ...
        player_idle_1_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 01.png')
        self.player_idle_1 = pg.transform.scale(player_idle_1_img, (128, 80))
        player_idle_2_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 02.png')
        self.player_idle_2 = pg.transform.scale(player_idle_2_img, (128, 80))
        player_idle_3_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 03.png')
        self.player_idle_3 = pg.transform.scale(player_idle_3_img, (128, 80))
        player_idle_4_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 04.png')
        self.player_idle_4 = pg.transform.scale(player_idle_4_img, (128, 80))
        player_idle_5_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 05.png')
        self.player_idle_5 = pg.transform.scale(player_idle_5_img, (128, 80))
        # Captain Clown Nose (Idle left)
        player_idle_left_1_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 01.png')
        ...
        player_idle_left_2_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 02.png')
        ...
        player_idle_left_3_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 03.png')
        ...
        player_idle_left_4_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 04.png')
        ...
        player_idle_left_5_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/01-Idle/Idle 05.png')
        ...
        player_right_1_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 01.png')
        self.player_right_1 = pg.transform.scale(player_right_1_img, (128, 80))
        player_right_2_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 02.png')
        self.player_right_2 = pg.transform.scale(player_right_2_img, (128, 80))
        player_right_3_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 03.png')
        self.player_right_3 = pg.transform.scale(player_right_3_img, (128, 80))
        player_right_4_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 04.png')
        self.player_right_4 = pg.transform.scale(player_right_4_img, (128, 80))
        player_right_5_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 05.png')
        self.player_right_5 = pg.transform.scale(player_right_5_img, (128, 80))
        player_right_6_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 06.png')
        self.player_right_6 = pg.transform.scale(player_right_6_img, (128, 80))
        # Captain Clown Nose (Run left)
        player_left_1_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 01.png')
        ...
        player_left_2_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 02.png')
        ...
        player_left_3_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 03.png')
        ...
        player_left_4_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 04.png')
        ...
        player_left_5_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 05.png')
        ...
        player_left_6_img = pg.image.load('./Sprites/Captain Clown Nose without Sword/02-Run/Run 06.png')
